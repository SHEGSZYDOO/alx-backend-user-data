0 - Download and start your project from this archive.zip
...
3 - Now you will create a class to manage the API authentication.
...
5 - Now you will validate all requests to secure the API:
...
6  - Create a class BasicAuth that inherits from Auth. For the moment this class will be empty.
...
11 - Now, you have all pieces for having a complete Basic authentication.
